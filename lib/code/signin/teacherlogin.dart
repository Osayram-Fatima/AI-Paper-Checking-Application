...
class _TeacherLoginState extends State<TeacherLogin> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // ✅ resizeToAvoidBottomInset false — keyboard pe spheres nahi hilenge
      ...
      body: Stack(
        children: [
          ...
          // ── BOTTOM Spheres — ✅ ignore keyboard, hamesha neeche rahenge ──
          Positioned(bottom: -60, left: -100, child: _buildCircle(250)),
          Positioned(bottom: 120, left: 90, child: _buildCircle(60)),

          // ── MAIN CONTENT ──
          SafeArea(
            child: SingleChildScrollView(
              // ✅ keyboard pe scroll kare — spheres nahi hilenge
              keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
              padding: const EdgeInsets.symmetric(horizontal: 28),
              child: SizedBox(
                height:
                    height, // ✅ full height fix — content overflow nahi hoga
                child: Column(
  ...
  Widget _buildTextField(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        // ✅ Password eye icon — pehle missing tha
