...
class StudentProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String fullName =
        (UserSession.firstName.isNotEmpty && UserSession.lastName.isNotEmpty)
        ? "${UserSession.firstName} ${UserSession.lastName}"
        : "Student";

    final String initials =
        (UserSession.firstName.isNotEmpty && UserSession.lastName.isNotEmpty)
        ? "${UserSession.firstName[0]}${UserSession.lastName[0]}".toUpperCase()
        : "S";
    ...
    final String role = UserSession.role.isNotEmpty
        ? UserSession.role[0].toUpperCase() + UserSession.role.substring(1)
        : "Student";
  ...
  // ── Completion % based on UserSession fields ──
  static int _calcCompletion() {
    ...
    if (UserSession.profileImage != null &&
        UserSession.profileImage!.isNotEmpty)
      filled++;
    return filled * 20; // 5 fields × 20% = 100%
  }
}
