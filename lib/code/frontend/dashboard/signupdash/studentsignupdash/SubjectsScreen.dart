...
class _SubjectsScreenState extends State<SubjectsScreen>
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Subjects will be shown here once your teacher adds you to a class.",
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              "Your teacher will add subjects once classes start.",
              style: TextStyle(
                color: const Color(0xFFB0BAD3).withOpacity(0.85),
                fontSize: 13.5,
                height: 1.5,
  ...
  Widget _buildNavBar() {
    const int selectedIndex = 2; // Subjects tab selected
