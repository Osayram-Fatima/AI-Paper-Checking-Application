...
class _ResultsScreenState extends State<ResultsScreen>
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Your results will appear here after your teacher checks your papers.",
  ...
  Widget _buildIllustration() {
    return Container(
      ...
      child: Stack(
        ...
        children: [
          const Icon(Icons.assignment_rounded, size: 60, color: Colors.white),
          Positioned(
            bottom: 10,
            right: 10,
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xFF6B8BFF), Color(0xFF4A6CFF)],
                ),
                shape: BoxShape.circle,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              "Results update automatically when your teacher finishes grading.",
              style: TextStyle(
                color: const Color(0xFFB0BAD3).withOpacity(0.85),
                fontSize: 13.5,
                height: 1.5,
  ...
  Widget _buildNavBar() {
    const int selectedIndex = 1; // Results tab selected
