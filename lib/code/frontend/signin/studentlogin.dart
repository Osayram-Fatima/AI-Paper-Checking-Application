import 'dart:convert';
import 'package:ai_paper_checking/code/frontend/signin/teacherlogin.dart';
...
import 'package:ai_paper_checking/code/frontend/dashboard/signupdash/studentsignupdash/student_dashboard.dart'; // ✅ ADD
  ...
  Future<void> _handleStudentLogin(BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // ✅ StudentDashboard pe navigate karo
