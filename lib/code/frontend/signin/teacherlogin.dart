...
import 'package:ai_paper_checking/code/frontend/signin/studentlogin.dart';
import 'package:ai_paper_checking/code/frontend/signup/signup.dart';
import 'package:ai_paper_checking/code/frontend/session/user_session.dart'; // ✅ ADD
import 'package:ai_paper_checking/code/frontend/dashboard/signupdash/teachersignupdash/teacher_dashboard.dart'; // ✅ ADD
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:http/http.dart' as http; // ✅ ADD
  ...
  Future<void> _handleTeacherLogin(BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // ✅ TeacherDashboard pe navigate karo
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Server se connection nahi. Internet check karein."),
          backgroundColor: Colors.red,
        ),
      );
    } finally {
